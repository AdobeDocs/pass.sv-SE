...
*Clickstream-data* representerar data som delas av kunder i sessionens pulsslag (till exempel subjectID, mvpdName och metadata). Alla anpassade metadatafält refereras i [standardmetadataattributen](/help/concurrency-monitoring/technical/standard-metadata-attributes.md).
