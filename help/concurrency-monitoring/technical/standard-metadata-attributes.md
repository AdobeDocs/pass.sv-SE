...
API:t för övervakning av samtidig användning tvingar klienter att skicka följande värden som en del av ett giltigt initieringsanrop: [initieringsanrop för session](/help/concurrency-monitoring/technical/restrict-concurr-usage-mult-apps.md#api-calls-descr).
...
Om något av dessa attribut krävs för de definierade profilerna med [API v2.0](https://streams-stage.adobeprimetime.com/swagger-ui/index.html) resulterar ett försök att starta en session utan det attributet i en 400-felaktig begäran.
...
* [Policybeslutspunkt](/help/concurrency-monitoring/technical/cm-policy-decision-point.md)
* [API-konsol - Adobe Concurrency Monitoring](https://streams-stage.adobeprimetime.com/swagger-ui/index.html)
