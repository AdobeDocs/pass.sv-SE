...
För bästa datakvalitet rekommenderar vi rapporter som presenteras på den här sidan [Exempel på CMU-rapporter](/help/concurrency-monitoring/reports/cm-usage-reports-examples.md)
