...
Den första principen innehåller en regel som tillåter högst två samtidiga strömmar. Den senaste strömmen kan spelas upp.
Den andra principen innehåller två regler. Den tillåter högst 3 samtidiga strömmar från högst 2 enheter och den senaste strömmen kan spelas upp.


## En profil med en regel

Vår första policy innehåller en enda regel: inte fler än två samtidiga strömmar tillåts, den första strömmen som ska startas stoppas om tre samtidiga strömmar spelas upp.

Två appar + en webbplats används för att starta strömmar:
