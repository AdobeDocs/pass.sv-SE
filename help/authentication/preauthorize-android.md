...
Om ett oväntat fel inträffar (t.ex. nätverksproblem, slutpunkten för MVPD-auktorisering är inte tillgänglig osv.) när en förauktoriserings-API-begäran bearbetas av Adobe Pass Authentication Services, kommer en eller flera separerade felinformation att inkluderas för de berörda resurserna som en del av förauktoriserings-API-svarsresultatet.
