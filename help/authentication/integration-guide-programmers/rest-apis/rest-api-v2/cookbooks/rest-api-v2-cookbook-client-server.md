...
För att få åtkomst-token måste programmet följa de steg som beskrivs i dokumentationen för [Dynamisk klientregistrering](../../rest-api-dcr/apis/dynamic-client-registration-apis-retrieve-access-token.md).
