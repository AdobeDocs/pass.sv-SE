...
Börja med det här avsnittet om du arbetar med ett program som behöver integrera REST API V2, oavsett om det är ett nytt eller befintligt program som migreras från [REST API V1](#migration-rest-api-v1-to-rest-api-v2) eller [SDK](#migration-sdk-to-rest-api-v2).
