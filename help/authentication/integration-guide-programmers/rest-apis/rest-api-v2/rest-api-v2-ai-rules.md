---
title: REST API V2 AI-regler
description: REST API V2 AI-regler
...
# REST API V2 AI-regler {#rest-api-v2-ai-rules}

>[!IMPORTANT]
>
> Innehållet på den här sidan tillhandahålls endast i informationssyfte. Användning av denna API kräver en aktuell licens från Adobe. Ingen obehörig användning är tillåten.

Det här dokumentet förser Adobe Pass Authentication-kunder med strukturerade regler och bästa praxis som särskilt utformats för AI-assisterad utveckling av TVE-program (TV Everywhere) med [REST API V2](rest-api-v2-overview.md).

Genom att följa de AI-utvecklingsregler som beskrivs i den här handboken kan utvecklare se till att deras AI-kodningsassistenter hjälper till att skapa kompatibla, prestanda och underhållserbara integreringar som uppfyller de [obligatoriska kraven och rekommenderade metoderna](rest-api-v2-checklist.md).

## Regler för kodningsassistenter {#coding-assistants-rules}

Regler ger instruktioner på systemnivå till agenter. Betrakta dem som kontext, inställningar eller arbetsflöden. Reglerna i det här dokumentet är kompatibla med vanliga AI-baserade kodningsassistenter och transformera [REST API V2 Checklist](rest-api-v2-checklist.md) till åtgärdbara AI-utvecklingsriktlinjer.

Kom igång redan idag genom att konfigurera din AI-utvecklingsmiljö med vår omfattande regeluppsättning och upplev fördelarna med intelligent, kompatibel kodgenerering för din integrering med Adobe Pass Authentication REST API V2. Kopiera och klistra in nedanstående regler i utvecklingsmiljöns konfigurationsfil beroende på vilket AI-verktyg du använder.
...
- Retrieve configuration for specific service provider: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-configuration-apis/rest-api-v2-configuration-apis-retrieve-configuration-for-specific-service-provider
- Create authentication session: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-create-authentication-session
- Resume authentication session: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-resume-authentication-session
- Retrieve authentication session: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-retrieve-authentication-session-information-using-code
- Perform authentication in user agent: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-sessions-apis/rest-api-v2-sessions-apis-perform-authentication-in-user-agent
- Retrieve profiles: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profiles
- Retrieve profile for specific mvpd: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-mvpd
- Retrieve profile for specific code: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-profiles-apis/rest-api-v2-profiles-apis-retrieve-profile-for-specific-code
- Retrieve authorization decisions using specific mvpd: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-authorization-decisions-using-specific-mvpd
- Retrieve preauthorization decisions using specific mvpd: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-decisions-apis/rest-api-v2-decisions-apis-retrieve-preauthorization-decisions-using-specific-mvpd
- Initiate logout for specific mvpd: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-logout-apis/rest-api-v2-logout-apis-initiate-logout-for-specific-mvpd
- Retrieve partner authentication request: https://experienceleague.adobe.com/sv/docs/pass/authentication/integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-apis/rest-api-v2-partner-single-sign-on-apis/rest-api-v2-partner-single-sign-on-apis-retrieve-partner-authentication-request
