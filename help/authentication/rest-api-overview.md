...
| **Funktionalitet** | **Ansvarig för hantering av funktionen** | **Beskrivning av begränsningarna i det aktuella klientlösa API:t och skillnader från systemspecifika SDK:er** |
| --- | --- | --- |
...
För att kunna använda Adobe Pass Authentication REST API måste enheterna uppfylla eller överskrida de lägsta tekniska kraven som anges i REST API-avsnittet i [Adobe Pass Authentication Platform / Device / Tools Requirements document](#general_clientless_reqs).
